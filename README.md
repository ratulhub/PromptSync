...
- [Why Use PromptSync?](#why-use-promptsync)
- [What's New in v3.1.1](#whats-new-in-v311)
- [Browser Support](#browser-support)
- [Installation](#installation)
  - [Chrome / Edge / Brave / Opera](#chrome--edge--brave--opera)
  - [Firefox / Zen Browser / Firefox for Android](#firefox--zen-browser--firefox-for-android)
...
### Firefox / Zen Browser / Firefox for Android
...
#### Step 2A — Temporary Load (about:debugging) ✅ Recommended for local testing

1. Open Firefox / Zen → navigate to `about:debugging`
2. Click **This Firefox** in the left sidebar
3. Click **Load Temporary Add-on...**
4. Navigate to `build/firefox/` → select `manifest.json` ✅

> ⚠️ **Do NOT use** `about:addons` → *"Install Add-on From File"* for local testing. Firefox will flag the extension as **"corrupt"** because it is unsigned by Mozilla. Always use `about:debugging` for unpacked local loads.
